...
class ClientRegisterationTest {
	...
	@BeforeEach
	void init() {
		new_client= new Client("Ashhar","ashh@gmail.com","2020-2-2","India","38100","adhaar","208979677");
		
	}
	
	@Test
	void testClientRegisteration() {
		Client new_client2= new Client("Ahhar","ashh@gmail.com","2020-2-2","India","2334","adhaar","208979677");
	...
	void testClientRegisteration_failure_already_exists() {
		Client new_client2= new Client("Ashhara","asaahh@gmail.com","2020-2-2","Indiaaa","87751","adhaaaar","2081979677");
