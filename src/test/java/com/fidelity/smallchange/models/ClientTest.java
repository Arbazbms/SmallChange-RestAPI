...
class ClientTest {
	...
	@BeforeEach
	void init() {
		client=new Client("C101","ashr@gmail.com","password123","2020-2-2","India","678987","adhaar","208979677","");
	}
	@Test
	...
	void testClientCreation_failure_emptycountry() {
		Exception e= assertThrows(IllegalArgumentException.class,()->{
			Client client2=new Client("Ashhar","ashh@gmail.com","password123","2020-2-2","","232","adhaar","208979677","");});
	...
	void testClientCreation_failure_emptyemail() {
		Exception e= assertThrows(IllegalArgumentException.class,()->{
			Client client2=new Client("Ashhar",null,"password123","2020-2-2","","22","adhaar","208979677","");});
	...
	void testClientCreation_failure_nulldate() {
		Exception e= assertThrows(IllegalArgumentException.class,()->{
			Client client2=new Client("Ashhar","ashh@gmail.com","password123",null,"india","22","adhaar","208979677","");});
	...
	void testClientCreation_failure_nullid() {
		Exception e= assertThrows(IllegalArgumentException.class,()->{
			Client client2=new Client("Ashhar","@gmail.com","password123","2020-2-2","India","222",null,null,"");});
